...
#define LN2SQUAIWS 0.4804530139182014246671025263266649717305529515945455
...
vData(min((unsigned int)(-1  / LN2SQUAIWS * nElements * log(nFPRate)), MAX_BLOOM_FILTER_SIZE * 8) / 8),
